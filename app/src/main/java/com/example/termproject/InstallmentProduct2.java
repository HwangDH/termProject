...
public class InstallmentProduct2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_installment_product2);
    ...
    public void showList(){
        try{
            ...
            while(count < jsonArray.length()){
                ...
                bankid[count] = object.getInt("Bank_ID5");
                productID[count] = object.getInt("InstallmentProduct_ID");
                productName[count] = object.getString("InstallmentProduct_Name");
